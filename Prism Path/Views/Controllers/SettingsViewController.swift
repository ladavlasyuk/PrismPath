...
final class SettingsViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        constraints += LayoutMetrics.constrainContentWidth(of: playerLabel, in: contentView, inset: inset)
        constraints += LayoutMetrics.constrainContentWidth(of: playerCard, in: contentView, inset: inset)
        constraints += LayoutMetrics.constrainContentWidth(of: themeLabel, in: contentView, inset: inset)
        constraints += LayoutMetrics.constrainContentWidth(of: themeCollectionView, in: contentView, inset: inset)
        constraints += LayoutMetrics.constrainContentWidth(of: hapticsToggle, in: contentView, inset: inset)
        constraints += LayoutMetrics.constrainContentWidth(of: soundToggle, in: contentView, inset: inset)
        constraints += LayoutMetrics.constrainContentWidth(of: trailToggle, in: contentView, inset: inset)
        constraints += LayoutMetrics.constrainContentWidth(of: resetButton, in: contentView, inset: inset + 20)
        constraints += LayoutMetrics.constrainContentWidth(of: resetWarningLabel, in: contentView, inset: inset + 20)
