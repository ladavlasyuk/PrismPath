...
final class HighScoresViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        constraints += LayoutMetrics.constrainContentWidth(of: tableView, in: view, inset: inset)
        if LayoutMetrics.isPad {
            constraints.append(emptyLabel.widthAnchor.constraint(lessThanOrEqualToConstant: LayoutMetrics.contentMaxWidth))
        }
